...
export default function SalaryCalculator() {
  ...
  const t = {
    bm: {
      ...
      disclaimer: "* Anggaran berdasarkan kadar EPF, SOCSO, EIS & PCB 2024/2025. Untuk rujukan sahaja — semak dengan majikan atau LHDN.",
    },
    en: {
      ...
      disclaimer: "* Estimates based on 2024/2025 EPF, SOCSO, EIS & PCB rates. For reference only — verify with your employer or LHDN.",
    },
  };
  const s = t[lang];
